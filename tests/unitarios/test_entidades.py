...
class BoletoMontandoMalote(unittest.TestCase):
    ...
    def test_deve_ter_propriedades(self):
        entidades.Malote('configuracao').to_dict().should.be.equal({
            ...
            'data_documento': None, 'data_processamento': None, 'data_vencimento': None, 'dias_vencimento': 2,
    ...
    def test_monta_conteudo_com_formato_invalido(self):
        ...
        self.malote.to_dict().should.be.equal({'banco_agencia': '1234', 'banco_conta': '234456', 'banco_convenio': None, 'banco_nome': 'Banco 1', 'carteira_numero': 222, 'data_documento': date(2015, 2, 28), 'data_processamento': date(2015, 2, 28), 'data_vencimento': date(2015, 3, 2), 'dias_vencimento': 2, 'empresa_beneficiario': 'Beneficiario', 'empresa_cidade': 'Rio de Janeiro', 'empresa_cnpj': '12345678901', 'empresa_endereco': 'Endere\xc3\xa7o Empresa', 'empresa_estado': 'RJ', 'formato': 'linha_digitavel', 'linha_1': 'LINHA 1', 'linha_2': '', 'linha_3': '', 'nosso_numero': None, 'numero_documento': 1234, 'sacado': ['Cliente entrega', 'Endere\xc3\xa7o, 23, complemento - Bairro, Cidade / MG - CEP: 33555666'], 'valor_documento': 100.4})
