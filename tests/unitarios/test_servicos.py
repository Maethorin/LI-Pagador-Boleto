...
class BoletoEntregandoPagamento(unittest.TestCase):
    ...
    def test_envia_pagamento_bradesco(self):
        self.malote.monta_conteudo(self.pedido, {}, dados={})
        entrega = servicos.EntregaPagamento(234)
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '23791.23421 50000.000120 34002.344504 1 63580000010040'})
    ...
    def test_envia_pagamento_bradesco_com_nosso_numero(self):
        self.malote.nosso_numero = 12344
        self.malote.monta_conteudo(self.pedido, {}, dados={})
        entrega = servicos.EntregaPagamento(234)
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '23791.23421 50000.001235 44002.344503 3 63580000010040'})

    def test_envia_pagamento_itau(self):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '34191.75009 00123.431231 42344.560000 8 63580000010040'})

    def test_envia_pagamento_banco_do_brasil_convenio_6(self):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '00191.23454 60000.000004 00001.234210 5 63580000010040'})

    def test_envia_pagamento_banco_do_brasil_convenio_7(self):
        self.malote.configuracao.json['banco'] = '3'
        self.malote.configuracao.json['carteira'] = '3'
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '00190.00009 01234.567004 00001.234186 5 63580000010040'})

    def test_envia_pagamento_banco_do_brasil_convenio_8(self):
        self.malote.configuracao.json['banco'] = '3'
        self.malote.configuracao.json['carteira'] = '3'
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '00190.00009 01234.567806 00001.234186 9 63580000010040'})

    def test_envia_pagamento_caixa_economica(self):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '10490.23441 51000.200041 00000.123455 2 63580000010040'})

    def test_envia_pagamento_santander(self):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '03399.12347 56700.000005 01234.301024 3 63580000010040'})

    def test_envia_pagamento_hsbc(self):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': '39991.23452 67000.000009 01234.064523 8 63580000010040'})
    ...
    def test_dar_erro_para_banco_nao_existente(self):
        ...
        entrega = servicos.EntregaPagamento(234)
        entrega.malote = self.malote
        entrega.enviar_pagamento.when.called_with().should.throw(servicos.BoletoInvalido, u'Boleto para Não Existe ainda não implementado.')
    ...
    def test_boleto_em_pdf(self, boleto_pdf_mock, string_mock):
        ...
        entrega.malote = self.malote
        entrega.enviar_pagamento()
        entrega.resultado.conteudo.should.be.equal({'dados': 'BOLETO_PDF'})
