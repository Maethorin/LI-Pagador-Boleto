...
class BoletoEntregandoPagamento(unittest.TestCase):
    ...
    def test_processa_dados_de_pagamento_bradesco(self):
    ...
    def test_processa_dados_de_pagamento_bradesco_com_nosso_numero(self):
    ...
    def test_processa_dados_de_pagamento_itau(self):
    ...
    def test_processa_dados_de_pagamento_banco_do_brasil_convenio_6(self):
    ...
    def test_processa_dados_de_pagamento_banco_do_brasil_convenio_7(self):
        self.malote.configuracao.json['banco'] = '3'
        self.malote.configuracao.json['carteira'] = '3'
    ...
    def test_processa_dados_de_pagamento_banco_do_brasil_convenio_8(self):
        self.malote.configuracao.json['banco'] = '3'
        self.malote.configuracao.json['carteira'] = '3'
    ...
    def test_processa_dados_de_pagamento_caixa_economica(self):
    ...
    def test_processa_dados_de_pagamento_santander(self):
    ...
    def test_processa_dados_de_pagamento_hsbc(self):
    ...
    def test_dar_erro_para_banco_nao_existente(self):
        ...
        entrega = servicos.EntregaPagamento(234)
        entrega.malote = self.malote
        entrega.processa_dados_de_pagamento.when.called_with().should.throw(servicos.BoletoInvalido, u'Boleto para Não Existe ainda não implementado.')
