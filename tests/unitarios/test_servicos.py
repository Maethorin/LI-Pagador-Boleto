...
from pagador_boleto import entidades, servicos
...
class BoletoEntregandoPagamento(unittest.TestCase):
    def setUp(self):
        ...
        self.pedido.cliente_documento = '12345679801'
    ...
    def test_processa_dados_pagamento_bradesco(self):
        ...
        entrega.resultado.should.be.equal({'dados': '23791.23421 50000.000120 34002.344504 3 63550000010040'})
    ...
    def test_processa_dados_pagamento_bradesco_com_nosso_numero(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '23791.23421 50000.001235 44002.344503 7 63550000010040'})
    ...
    def test_processa_dados_pagamento_itau(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '34191.75009 00123.431231 42344.560000 1 63550000010040'})
    ...
    def test_processa_dados_pagamento_banco_brasil_convenio_6(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '00191.23454 60000.000004 00001.234210 9 63550000010040'})
    ...
    def test_processa_dados_pagamento_banco_brasil_convenio_7(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '00190.00009 01234.567004 00001.234186 9 63550000010040'})
    ...
    def test_processa_dados_pagamento_banco_brasil_convenio_8(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '00190.00009 01234.567806 00001.234186 2 63550000010040'})
    ...
    def test_processa_dados_pagamento_caixa_economica(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '10490.23441 51000.200041 00000.123455 6 63550000010040'})
    ...
    def test_processa_dados_pagamento_santander(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '03399.12347 56700.000005 01234.301024 7 63550000010040'})
    ...
    def test_processa_dados_pagamento_hsbc(self):
        ...
        entrega.malote = self.malote
        entrega.processa_dados_pagamento()
        entrega.resultado.should.be.equal({'dados': '39991.23452 67000.000009 01234.061529 2 63550000010040'})
    ...
    def test_deve_definir_pedido_e_configuracao(self, define_mock):
        entrega = servicos.EntregaPagamento(234)
        entrega.define_pedido_e_configuracao(1234)
        define_mock.assert_called_with(1234)

    @mock.patch('pagador.servicos.EntregaPagamento.define_pedido_e_configuracao')
    def test_definir_pedido_e_configuracao_nao_trata_erro_se_for_teste_e_nao_for_erro_especifico(self, define_mock):
        define_mock.side_effect = ValueError('ZAS')
        entrega = servicos.EntregaPagamento(234)
        entrega.define_pedido_e_configuracao.when.called_with('TESTE-BOLETO').should.throw(ValueError, 'ZAS')
